...
class _WrapperState extends State<Wrapper> {
  ...
  Widget build(BuildContext context) {
    ...
    if (user == null && usedBefore) {
      ...
      return OnBoardingScreen(
        onFinishClicked: changeUsedBefore,
      );
    } else {
  ...
  Future<int> checkPaymentInfo() async {
    ...
    if (result.exists) {
      ...
      bool expired = paymentModel.acceptedDate == null
          ? false
          : paymentModel.acceptedDate.difference(DateTime.now()).inDays > 60;

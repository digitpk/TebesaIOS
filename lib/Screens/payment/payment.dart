            ...
            children: [
              ...
              widget.expired
                  ? Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text(
                        'Your Last Payment has expired! please pay to continue using the application.',
                        style: TextStyle(
                            fontSize: 17,
                            color: Colors.red,
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(
                  'Full bank information will be sent to your email.',
                  style: TextStyle(
                      fontSize: 15,
                      color: Colors.grey[800],
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'My Email',
                    labelStyle:
                        TextStyle(color: Colors.grey[800], fontSize: 19.0),

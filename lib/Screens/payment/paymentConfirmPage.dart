            ...
            ? Center(
                child: Container(
                  ...
                  child: CircularProgressIndicator(
                    strokeWidth: 2.0,
                    valueColor:
                        new AlwaysStoppedAnimation<Color>(Colors.grey[800]),
                  ),
                ),
              )
            : Icon(
                    ...
                    children: [
                      widget.denied
                          ? Padding(
                              ...
                              child: Text(
                                'Your Payment confirmation has been denied! please check and fill the form again.',
                                style: TextStyle(
                                    fontSize: 17,
                                    color: Colors.red,
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                          'Please fill this form after paying!',
                          style: TextStyle(
                              fontSize: 15,
                              color: Colors.red,
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  '${paymentModel.date.day}/${paymentModel.date.month}/${paymentModel.date.year}',
                                  style: TextStyle(
                                      fontSize: 17,
                                      color: Colors.green,
                                      fontWeight: FontWeight.w500,
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            labelStyle: TextStyle(
                                color: Colors.grey[800], fontSize: 19.0),
                          ),
                        ),
                      ),
                      Padding(
                          ...
                          onTap: () async {
                            ...
                            if (_formKey.currentState.validate()) {
                              ...
                              _scaffoldKey.currentState
                                  .showSnackBar(snackBarRegistered);

                              //Updating the paymentRequest detail
                              await databaseService.updatePayment(
                                  transactionRef: tRefNumber.text,
                                  depositedByName: depositedByName.text);

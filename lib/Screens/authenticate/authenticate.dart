...
class _AuthenticateState extends State<Authenticate> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Provider.of<AuthState>(context).getUserIn == 0
          ? Stack(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      gradient: LinearGradient(
                          colors: [Color(0xFFFFC2D7), Colors.white],
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image: AssetImage(
                                    'assets/logo/tebesa_logo_100.png'),
                                fit: BoxFit.cover)),
                      ),
                      ...
                      Padding(
                        ...
                        child: Center(
                          child: TextButton.icon(
                            ...
                            onPressed: () {
                              _launchURL(
                                  "https://www.termsandconditionsgenerator.com/live.php?token=jj9Vex6yFR527ipYYJoF3bcFEpLTOS6C");
                            },
                          ),
                        ),
                      ),

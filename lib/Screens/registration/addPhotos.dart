                ...
                child: SpringButton(
                  ...
                  onTap: () async {
                    if (photos.isNotEmpty) {
                      ...
                      Provider.of<RegistrationDataState>(context, listen: false)
                          .AddPageThreeData(pics);

                      UserModel user = Provider.of<RegistrationDataState>(
                              context,
                              listen: false)
                          .getRegistrationData;

          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              MessageModel message =
                  MessageModel.fromJson(widget.snapshot.data.documents[index]);
              int sendFrom;
              if (message.from ==
              ...
              children: <Widget>[
                ...
                Bubble(
                      ...
                      : message.type == 'audio'
                          ...
                          : Text(message.message,
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w400,
                                  fontSize: 14)),
                  nip: who == 1 && message.type != 'image'
                      ? BubbleNip.leftBottom
                      : who == 0 && message.type != 'image'
                  ...
                  padding: message.type == 'image'
                      ...
                      : BubbleEdges.all(10),
                  alignment:
                      who == 1 ? Alignment.centerLeft : Alignment.centerRight,
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Text(
                        DateFormat('h:mm a').format(message.time).toString(),
                        style: TextStyle(
